...
const AuthDialog = ({ isOpen, onClose, error, onLogin, onRegister }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      console.log("AuthDialog opened with OAuth URLs:", {
        google: googleLoginUrl,
        github: githubLoginUrl,
        linkedin: linkedinLoginUrl
      });
    }
  }, [isOpen, googleLoginUrl, githubLoginUrl, linkedinLoginUrl]);
        ...
        <div className={styles.content}>
          ...
          <div className={styles.footer}>
            <p className={styles.registerText}>
              ...
              <button className={styles.textButton} onClick={onRegister}>
                Register
              </button>
            </p>
          </div>
